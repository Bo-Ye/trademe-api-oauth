 ...
 */
public class TrademeTemplate1 {
    private static final String CALLBACK_URL = "http://localhost:8080/trademe-api-oauth/watch-list-callback";
    private static TrademeTemplate1 instance;
    private Twitter twitter = TwitterFactory.getSingleton();

    private TrademeTemplate1() {

    }

    public static synchronized TrademeTemplate1 getInstance() {
        if (instance == null) {
            instance = new TrademeTemplate1();
        }
        return instance;
    }
